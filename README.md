...
9. Type in your web browser or click [localhost:9117](localhost:9117)
...
6. Now Jackett will automatically start on boot-uo. Check that it is running by typing in your web browser or click [localhost:9117](localhost:9117)
