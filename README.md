...
7. Now Jackett will automatically start on boot-uo. Check that it is running by typing in your web browser or click [http://localhost:9117](http://localhost:9117)
